...
@section('content')
    ...
    <article class="page-container">
        <form action="{{ url('System/Subject/Store') }}" method="post" class="form form-horizontal" id="form-admin-role-add">
            {{ csrf_field() }}
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学科名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" id="subject_name" name="subject_name">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="number" min="0" value="0" class="input-text" id="sort" name="sort">
                </div>
            </div>
            <div class="row cl">
